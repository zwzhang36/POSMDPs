...
from tools.helper_OFC import Dict2Class, sample
from tools.helper_OFC import Agent, Recorder
    ...
    for task_space in ['poz_rwd', 'poz']:
        for lesion in [True, False]: # False, 
            ...
            setting = Dict2Class({'task_space': task_space, 'lesion': lesion,
                                  'replay': False, 'nRuns': 5, 'nBlocks': nBlocks,
            ...
            parameters = Dict2Class({'state_map': task_space,
                                     ...
                                     'dt': 0.1,
                                     'largerP': 0.5, # for lesion in 'poz' state space
                                     'e_decay': 0.99,
                                     'baseline': Dict2Class({'T':1e-20,
                                                             'T_big': 1e-10, 
                                                             'D': 1e-4,
                                                             'O': 1e-4,
                                                             'O_cue': 1e10,
            ...
            # label/file name
            prefix = 'sham_OFC_Tonly_allequal_' if not setting.lesion else 'lesion_OFC_Tonly_allequal_'  # +str(parameters.largerP) + '_'
